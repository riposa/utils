...
// PlaceOrderResult represent place order response message from wx pay.
...
func (p *PlaceOrderResult) ToMap() map[string]string {
	retMap, err := ToMap(p)
	if err != nil {
		panic(err)
	}
...
// Parse the response message from wx pay to struct of PlaceOrderResult
...
// QueryOrder Result represent query response message from wx pay
...
func (q *QueryOrderResult) ToMap() map[string]string {
	retMap, err := ToMap(q)
	if err != nil {
		panic(err)
	}
...
// RefundOrder Result represent query response message from wx pay
...
func (q *RefundOrderResult) ToMap() map[string]string {
	retMap, err := ToMap(q)
	if err != nil {
		panic(err)
	}
...
func ParseRefundOrderResult(resp []byte) (RefundOrderResult, error) {
	res := RefundOrderResult{}
	err := xml.Unmarshal(resp, &res)
	return res, err
}
